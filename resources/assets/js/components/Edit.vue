  ...
  <div class="card card-body">
    <div class="row">
      <div class="row mt-3 mb-3">
        ...
        <div class="col">
          <div class="form-group">
            ...
            <input class="form-control" v-model="page.slug">
      ...
      <div class="row mt-3 mb-3 px-5">
        <button type="button" class="btn btn-primary" @click="editPage" :data-kt-indicator="is_loading? 'on':'off'" :disabled="is_loading">
...
export default {
  ...
  created() {
    this.page = Object.assign({}, this.pageData)
  },
  data: () => ({
    is_loading: false,
    page: {
  ...
  methods: {
    async editPage() {
      ...
      this.errors = {name: null, slug: null, content: null};

      await axios.patch(route('dashboard.pages.update', this.pageData.id), this.page).then((res) => {
